...
namespace WebApi.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        {
            using (var obj = new GasStationPharmacyEntities())
            {
                
                EMPLEADO entry = obj.EMPLEADOes.Where
                <EMPLEADO>(record => 
                record.Cedula.ToString() == context.UserName && 
                record.Contraseña == context.Password).FirstOrDefault();
